        ...
        <div className="card">
          <div className="card-body row">
            <div className="col-sm-6">
              <p className="card-text m-1"><FontAwesomeIcon style={{ fontSize: '20', marginRight: '10px' }} icon={faLocationDot} />Kuloglu Mahallesi Barbaros Bulvarı<br/> Yıldız İş Hanı No:9 34353 Beşiktaş/İstanbul</p>
            ...
            <div className="col-sm-6">
              ...
              <p className="card-text m-1"><FontAwesomeIcon style={{ fontSize: '20', marginRight: '10px' }} icon={faFacebook} />brightdansakademisi</p>
